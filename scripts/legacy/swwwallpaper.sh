...
lockFile="/tmp/hypr$(id -u)swwwallpaper.lock"
...
Wall_Update()
{
    ...
    echo "curtheme: ${curTheme}, x_update: {$x_update}, themectl: ${ThemeCtl}, scrdir: ${Scrdir}, cacheDir: {$cacheDir}, cacheImg: {$cacheImg}"
